...
static int c = 0;
int count_leaf_nodes(tree_type *root)
{
    if(root==NULL)
        return 0;
...
//LEAF NODES ARE THOSE PART OF A BINARY TREE WHICH HAVE NO LEFT OR RIGHT REFERENCE.
...
int main()
{
    ...
    cout<<endl<<"Number of Nodes : "<<count_leaf_nodes(root)<<endl;
    return 0;
}
